...
const content = PORTAL_CONTENT["insurance"];

export const Route = createFileRoute("/portals/insurance")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://aetherwealth.co/portals/insurance" },
    ],
    links: [{ rel: "canonical", href: "https://aetherwealth.co/portals/insurance" }],
  }),
