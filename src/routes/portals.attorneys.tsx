...
const content = PORTAL_CONTENT["attorneys"];

export const Route = createFileRoute("/portals/attorneys")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://aetherwealth.co/portals/attorneys" },
    ],
    links: [{ rel: "canonical", href: "https://aetherwealth.co/portals/attorneys" }],
  }),
