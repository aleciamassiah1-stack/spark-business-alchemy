-- One-time admin function to fully purge a single user by email.
-- Mirrors the logic of purge_expired_account_deletions but targets a specific user.
...
DECLARE
  victim_id uuid;
BEGIN
  -- Only admins (or service role) may execute
